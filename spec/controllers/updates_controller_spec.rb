...
describe UpdatesController do
  ...
  def valid_attributes
    FactoryGirl.attributes_for(:update)
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved update as @update" do
        ...
        post :create, {:update => { "title" => "invalid value" }}, valid_session
        assigns(:update).should be_a_new(Update)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested update" do
        ...
        Update.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => update.to_param, :update => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the update as @update" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Update.any_instance.stub(:save).and_return(false)
        put :update, {:id => update.to_param, :update => { "title" => "invalid value" }}, valid_session
        assigns(:update).should eq(update)
      end
